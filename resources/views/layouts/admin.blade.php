...
<head>
    ...
    <title>{{ config('app.name', 'Health - Klinik') }}</title>
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <div class="sidebar-brand-text mx-3">Health - Klinik</div>
        </a>
        ...
        <li class="nav-item {{Request::segment(1) === 'report' ? 'active' : null}}">
          ...
          <div id="report" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="{{route('signa.index')}}">Data Signa</a>
              <a class="collapse-item" href="{{route('resep.index')}}">Pembuatan Resep</a>
            </div>
          </div>
        </li>
        @if (auth()->user()->level == '1')
          {{-- <li class="nav-item {{Request::segment(1) === 'user_management' ? 'active' : null}}">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#user_management" aria-expanded="true" aria-controls="collapseTwo">
              <i class="fas fa-fw fa-user"></i>
              <span>Manajemen User</span>
            </a>
            <div id="user_management" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{route('user_management.index')}}">Data User</a>
              </div>
            </div>
          </li> --}}
        @endif
                    ...
                    <li class="nav-item dropdown no-arrow d-sm-none">
                      ...
                      <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                        <h6 class="dropdown-header">
                          Notification
                          <span class="float-right"> <a href="{{route('get_notification_detail', auth()->user()->id)}}" class="text-white">See all</a> </span>
                        </h6>
                        <div class="card">
